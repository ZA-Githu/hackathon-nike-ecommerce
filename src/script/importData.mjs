...
const client = createClient({
  projectId: process.env.SANITY_PROJECT_ID || "hm0e4hfr",
  dataset: process.env.SANITY_DATASET || "production",
  useCdn: false,
  apiVersion: '2021-08-31',
  token: process.env.SANITY_API_TOKEN || "sk1st8t6uQORnpgGM9KSvKMjmd7V7uWn2u6BymPimxpXNuhueZMFxxQ4uAeHygMTFQiwDseVDUeNgqsT9Ps2vi7OUx6bIDmdD4a4dcq2FM3qiFWjJMjZsAvZWoWTbk1cKrzZu3WmlnXm4JefW29DUinGRpylMkj7SckrDc6SpdOdWy2GeuLY",
});
